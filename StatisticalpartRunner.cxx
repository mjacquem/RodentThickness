	...
	if(Sub)
	{
		...
		{  			
				...
				if(i==0)
				{
					...
					if(column1.compare("group") != 0 && column2.compare("subjId") != 0  && column5.compare("surfacemodels") != 0 && column5.compare("attributefilename") != 0) 
				...
				if (i>0)
				{
					std::string BatchMakeScriptFile = WorkDir+"/RodentThickness/Script/"+"slicer3filetxt.bms";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////Pipeline3////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//file bms
	std::string BatchMakeScriptFile1 = WorkDir+"/RodentThickness/Script/"+"slicer3correspondence.bms";
